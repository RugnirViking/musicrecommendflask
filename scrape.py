...
def scrape():
    ...
    # open the webpage
    url = 'https://everynoise.com/engenremap-indianedm.html'
    ...
    for n, artist in enumerate(artists):
        print("INSERT INTO songs (name, artist, genre, spotify_id) VALUES (\"\",\""+str(artist)+"\",55,\""+str(links[n].replace("spotify:artist:",""))+"\");")
